package Nio.NioWork.singleFileupload;
...
public class Server {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //与本地端口绑定
        serverSocketChannel.socket().bind(new InetSocketAddress("192.168.1.57", 5555));
    ...
    public static void receiveData(SelectionKey selectionKey) throws IOException {
        ...
        // 文件
            ...
            if (fileLength - sum < 1024 * 1024) {
                buffer4 = ByteBuffer.allocate(Integer.valueOf(String.valueOf(fileLength - sum)));
